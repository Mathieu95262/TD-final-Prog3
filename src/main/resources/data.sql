...
-- Sample membership fees for each collectivity
INSERT INTO membership_fee (id, collectivity_id, label, amount, fee_type, active, created_at) VALUES
    ('FEE-001', 'COL-001', 'Cotisation mensuelle COL-001', 20000, 'MONTHLY', TRUE, '2022-01-15'),
    ('FEE-002', 'COL-001', 'Cotisation annuelle COL-001', 200000, 'ANNUAL', TRUE, '2022-01-15'),
    ('FEE-003', 'COL-002', 'Cotisation mensuelle COL-002', 15000, 'MONTHLY', TRUE, '2022-06-10'),
    ('FEE-004', 'COL-002', 'Cotisation annuelle COL-002', 150000, 'ANNUAL', TRUE, '2022-06-10'),
    ('FEE-005', 'COL-003', 'Cotisation mensuelle COL-003', 18000, 'MONTHLY', TRUE, '2023-03-20'),
    ('FEE-006', 'COL-003', 'Cotisation annuelle COL-003', 180000, 'ANNUAL', TRUE, '2023-03-20');

-- Sample payments
INSERT INTO member_payment (id, member_id, membership_fee_id, amount, payment_date, payment_mode) VALUES
    ('PAY-001', 'MEM-001', 'FEE-002', 200000, '2025-01-10', 'BANK_TRANSFER'),
    ('PAY-002', 'MEM-002', 'FEE-002', 200000, '2025-01-12', 'MOBILE_MONEY'),
    ('PAY-003', 'MEM-003', 'FEE-002', 200000, '2025-01-15', 'CASH'),
    ('PAY-004', 'MEM-005', 'FEE-002', 200000, '2025-02-01', 'BANK_TRANSFER'),
    ('PAY-005', 'MEM-013', 'FEE-004', 150000, '2025-01-08', 'BANK_TRANSFER'),
    ('PAY-006', 'MEM-014', 'FEE-004', 150000, '2025-01-09', 'MOBILE_MONEY');
